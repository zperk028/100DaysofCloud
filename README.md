...
- [ ] ☁️ 2 > [Day Two - The Plan](Journey/002/Readme.md)
- [ ] ☁️ 3 > [Day Three - Back on the 104 Horse, Slowly](Journey/003/Readme.md)
- [ ] ☁️ 4 > [Day Four - AD and RBAC](Journey/004/Readme.md)
- [ ] ☁️ 5 > [Day Five](Journey/005/Readme.md)
- [ ] ☁️ 6 > [Day Six](Journey/006/Readme.md)
...
- [ ] ☁️ 11 > [Day Eleven](Journey/011/Readme.md)
...
## More About Me
I'm a mid-30s career-changer. After 12+ years in an old media career in creative + business development exec, project manager, researcher, writer and sales adjacent roles, I lost the spark for that particularly stale medium. The Coronavirus pandemic accelerated my career change plans. In the span of less than two weeks I was part of a mass lay off at work and a mass state activation of reserve military personnel. I am currently still on active duty for my role for COVID response, but I am commited to using my free time in the evenings as wisely as possible to prepare for a new "future-proof" career in cloud security. 

Cybersecurity is a huge inerest of mine, but I am very aware that one does not simply walk into a cybersecurity career (despite what Bootcamp Inc. would try to sell you). My intent is to start with fundamentals network skills, but with a hyper-contemporary twist of using cloud basics as an entry point to this learning path. I am also trying to learn Linux fundamentals, JavaScript, and Python at the same time. So far I hate programming, and feel much more at home in a CLI. This is reinforcing my gut insticts that tell me I'm better suited as an administrator than a developer.
